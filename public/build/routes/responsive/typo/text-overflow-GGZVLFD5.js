...
init_react();
function Index() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Title, null, "No style"), /* @__PURE__ */ React.createElement(Text, null, "This is a narrow column of text, with a very long word: antidisestab", /* @__PURE__ */ React.createElement("span", {
    dangerouslySetInnerHTML: { __html: "&nbsp;" }
  }), "lishmentarianism."), /* @__PURE__ */ React.createElement(Text, null, "This is a narrow column of text, with a very long word: antidisestab lishmentarianism."), /* @__PURE__ */ React.createElement(Text, null, "This is a narrow column of text, with a very long word: antidisestablishmentarianism."), /* @__PURE__ */ React.createElement(Text, null, "This is a narrow column of text, with a very long word: antidisestab-lishmentarianism."), /* @__PURE__ */ React.createElement(Text, null, "The same problem happens with URLs: https://spiritlabs.co/blog/why-frontend-developers-prefer-react"), /* @__PURE__ */ React.createElement("hr", null), /* @__PURE__ */ React.createElement(Title, null, "overflow-wrap: break-word"), /* @__PURE__ */ React.createElement(Text, {
    break: "wrap"
...
//# sourceMappingURL=/build/routes/responsive/typo/text-overflow-GGZVLFD5.js.map
